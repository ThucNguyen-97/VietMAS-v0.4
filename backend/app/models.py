...
class Partner(Base):
    ...
    tax_code: Mapped[str] = mapped_column(String(30), unique=True, index=True)
    legal_representative: Mapped[str | None] = mapped_column(String(160), nullable=True)
    representative_title: Mapped[str | None] = mapped_column(String(120), nullable=True)
    address: Mapped[str | None] = mapped_column(Text, nullable=True)
    ...
    contract_no: Mapped[str | None] = mapped_column(String(80), nullable=True)
    contract_effective_date: Mapped[str | None] = mapped_column(String(20), nullable=True)
    contract_expired_date: Mapped[str | None] = mapped_column(String(20), nullable=True)
    ...
    deposit_percent: Mapped[str | None] = mapped_column(String(20), nullable=True)
    logo_url: Mapped[str | None] = mapped_column(String(500), nullable=True)
